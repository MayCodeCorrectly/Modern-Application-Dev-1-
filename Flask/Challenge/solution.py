...
def register():
    ...
    if request.method=="POST":
        ...
        image =request.form["image"] #it takes image name
        ...
        return render_template("review.html", name=name, gender=gender, age=age, qual=qual, 
                            stream=stream, address=address, image=f"./static/{image}")#LHS>jinja, RHS>data variables
